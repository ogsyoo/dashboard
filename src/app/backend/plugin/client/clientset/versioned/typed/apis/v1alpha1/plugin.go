...
import (
	...
	v1alpha1 "github.com/ogsyoo/dashboard/v2/src/app/backend/plugin/apis/v1alpha1"
	scheme "github.com/ogsyoo/dashboard/v2/src/app/backend/plugin/client/clientset/versioned/scheme"
