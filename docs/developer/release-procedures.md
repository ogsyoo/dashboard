...
4. Create a git [release](https://github.com/ogsyoo/dashboard/v2/releases/) tag for the merged pull request. Release description should include a changelog.
...
8. Release Helm Chart by running the `aio/scripts/helm-release-chart.sh` script from the newly created git tag, then push the git `gh-pages` branch of your `https://github.com/ogsyoo/dashboard/v2/` git remote.
